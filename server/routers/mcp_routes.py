...
SERVER_INFO = {"name": "getdraw", "title": "getdraw.app", "version": "1.0.0"}
...
TOOLS = [
    {
        "name": "list_drawings",
        "title": "List drawings",
        "description": "List the drawings in the user's getdraw.app account, newest first.",
        "inputSchema": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": (
            "Render a mermaid flowchart as a new getdraw.app drawing.\n\n"
    ...
    if method == "initialize":
        return _result(
            request_id,
            {
                ...
                "instructions": (
                    "Drawings live in the signed-in user's getdraw.app account.\n\n"
