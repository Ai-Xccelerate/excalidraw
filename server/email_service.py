...
RESEND_FROM = os.environ.get("RESEND_FROM", "getdraw.app <noreply@aixccelerate.com>")
        ...
        async with httpx.AsyncClient(timeout=10.0) as client:
            response = await client.post(
                ...
                json={
                    "from": RESEND_FROM,
                    "to": [to_email],
                    "subject": "Reset your getdraw.app password",
                    "html": (
                        "<p>Someone asked to reset the password for this getdraw.app "
...
async def send_email_verification(to_email: str, token: str) -> bool:
    ...
    return await _send(
        to_email,
        "Verify your getdraw.app email",
        (
            "<p>Confirm this address to finish setting up your getdraw.app account. "
...
async def send_existing_account_notice(to_email: str) -> bool:
    ...
    return await _send(
        to_email,
        "You already have a getdraw.app account",
        (
            "<p>Someone just tried to create a getdraw.app account with this "
